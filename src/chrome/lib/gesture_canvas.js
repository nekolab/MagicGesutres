...
Object.defineProperty(MagicGestures, "tab", {
    value: Object.create(null, {
        ...
        /**
         * MagicGestures.tab.recordMode
         * Indicate if recoding gesture
         * @type {boolean}
         */
        recordMode: {
            value: {
                        ...
                        switch(MagicGestures.tab.mouseHandler.currentState) {
                            case "free":
                                if (event.type == "mousedown") {
                                    ...
                                    MagicGestures.tab.mouseHandler.currentState = MagicGestures.tab.recordMode.enabled ? "ready" : "pushed";
                                } else {
...
/**
 * Setter for MagicGestures.runtime.currentProfile
 */
Object.defineProperty(MagicGestures.runtime, "currentProfile", {
    get: function() {
        return MagicGestures.runtime._currentProfile;
    },
    set: function(value) {
        MagicGestures.runtime._currentProfile = value;
        MagicGestures.tab.gesture.possibleNext = value.gestureTrie;
        MagicGestures.tab.gesture.neuralNetwork = MagicGestures.NeuralNetEngine.rebuildNetwork(value.neuralNetInfo);
    }
});